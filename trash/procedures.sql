...
drop procedure getPerpetualExpenditures;
DELIMITER //
CREATE PROCEDURE getPerpetualExpenditures(in monthFkP int, in  periodP int)
BEGIN
	select * from expendituremonth where monthsFk = monthFkP and period = periodP and monthPay = -1;
END//
DELIMITER ;

drop procedure getMonthExpenditures;
DELIMITER //
CREATE PROCEDURE getMonthExpenditures(in monthFkP int, in  periodP int)
BEGIN
	select * from expendituremonth where monthsFk = monthFkP and period = periodP and monthPay > 1;
END//
DELIMITER ;

drop procedure getUnicMonthExpenditures;
DELIMITER //
CREATE PROCEDURE getUnicMonthExpenditures(in monthFkP int, in  periodP int)
BEGIN
	select * from expendituremonth where monthsFk = monthFkP and period = periodP and monthPay = -2;
END//
DELIMITER ;

drop procedure getDayExpenditures;
DELIMITER //
CREATE PROCEDURE getDayExpenditures(in monthFkP int, in  periodP int)
BEGIN
	select * from expendituremonth where monthsFk = monthFkP and period = periodP and monthPay = 0;
END//
DELIMITER ;
/*=======================================*/
